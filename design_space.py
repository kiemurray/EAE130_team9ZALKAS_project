...
plt.axvline(W_S_landing_runway, color='magenta', linewidth=2, label='Arrestor Landing')
...
plt.plot(W_S, T_W_dashSLideal, color='cyan', linestyle='--', linewidth=2, label='Ideal Dash SL (M0.9)')
plt.plot(W_S, T_W_dash30, color='limegreen',  linewidth=2, label='Dash 30k ft (M1.6)')
plt.plot(W_S, T_W_dash30ideal, color='limegreen', linestyle='--', linewidth=1.8, label='Ideal Dash 30k ft (M2.0)')
plt.plot(W_S, T_W_maneuver, color='red', linewidth=2, label='Sustained Turn (8 deg/s)')
plt.plot(W_S, T_W_maneuver_ideal, color='red', linestyle='--', linewidth=2.2, label='Ideal Sustained Turn (10 deg/s)')
