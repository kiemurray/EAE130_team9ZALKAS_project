...
wf_climb =  0.93148704                                                            #weight fraction at start of climb
G = 0.024                                                                         #seroc/v_climb or set to 1.2% for FAR25
T_W_climb = ks**2*CD0/CLmax_climb + CLmax_climb*k_to/(ks**2) + G                  #thrust to weight ratio of climb
...
man_wf = mid_wf
T_W_maneuver = manuever_constraint(v_maneuver, rho_20, man_wf, T20_Tto, psi)       # thrust to weight maneuver
...
W_S_landing56lb = 0.5 * rho_sl * v_engage56lb**2 * CLmax_L                         #wing loading at landing
