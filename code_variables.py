...
S_fw = 90 # Firewall Surface Area, ft^2 (discuss estimation later)
...
D_f = 5.47 # Average Fuselage Depth, ft
W_f = 12.2   # Average Width of fuselage (ft)
...
L_a = 120 # Electrical Routing Distance, ft
L_d = 14.5 # Duct Length, ft
K_d = 2.75 # Duct Constant
L_s = 14.5 # Single Duct Length, ft
D_e = 2.58 # Engine Diameter, ft
L_tp = 1.5 # Length of Tailpipe, ft
L_sh = 11.85 # Length of Engine Shroud, ft
L_ec = 25.34 # Length From Engine Front to Cockpit, ft
...
We= calculate_empty_weight(S_w, S_ht, S_vt, S_wet_fuselage, W_TO, T_0 , num_engines)
